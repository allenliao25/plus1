...
/// auto-generated (web completeProfileSetup parity). Name, @handle, and
/// interest chips; photo upload deliberately deferred (dashed placeholder).
        ...
        ZStack {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 14) {
                    ...
                    // Photo placeholder — upload comes later.
                    HStack {
                        Spacer()
                        Circle()
